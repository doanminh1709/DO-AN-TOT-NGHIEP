...
export class SearchComponent implements OnInit {
  ...
  constructor(private productService: ProductService, private rateService: RateService, private cartService: CartService, private route: ActivatedRoute, private customerService: CustomerService, private toastr: ToastrService, private favoriteService: FavoritesService, private sessionService: SessionService, private router: Router) {
