...
export class RateComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private rateService: RateService, private toastr: ToastrService, private sesionService: SessionService, private customerService: CustomerService) {
